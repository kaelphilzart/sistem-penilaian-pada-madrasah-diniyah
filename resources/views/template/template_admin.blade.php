      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('data-tahun')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-time"></i>
                <div data-i18n="Layouts">Tahun Ajaran</div>
              </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{route('data-angkatan')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-time"></i>
                <div data-i18n="Layouts">Data Angkatan</div>
              </a>
            </li>
            
            <li class="menu-item">
              <a href="{{route('data-peserta-admin')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-id-card"></i>
                <div data-i18n="Layouts">Peserta Didik</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('akun-waliMurid')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-id-card"></i>
                <div data-i18n="Layouts">Akun Wali Murid</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('jadwal-admin')}}" class="menu-link">
...
<!-- 
            <li class="menu-item">
              <a href="###" class="menu-link">
                ...
                <div data-i18n="Layouts">Rekap Nilai</div>
              </a>
            </li> -->

            <li class="menu-item">
              <a href="{{route('rekap-absen')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-devices"></i>
                <div data-i18n="Layouts">Rekap Absen</div>
              </a>
            </li>
...
<!-- 
            <li class="menu-item">
              <a href="{{route('data-catatan')}}" class="menu-link">
    ...
    <div id="liveToast" class="toast @if(session('error') || session('success') || session('gagal_peserta')) show @else hide @endif" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            @if(session('gagal_peserta'))
                <img src="/img/close.png" class="rounded me-2" alt="Gagal Peserta" style="width: 16px; height: 16px;">
                <strong class="me-auto">Gagal Peserta</strong>
            @elseif(session('error'))
                <img src="/img/close.png" class="rounded me-2" alt="Gagal" style="width: 16px; height: 16px;">
                <strong class="me-auto">Gagal</strong>
            @elseif(session('success'))
                <img src="/img/success.png" class="rounded me-2" alt="Berhasil" style="width: 16px; height: 16px;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        @if (session('error') || session('success') || session('gagal_peserta'))

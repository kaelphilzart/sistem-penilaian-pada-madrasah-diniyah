      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="{{route('dashboard_kepalaMadrasah')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{route('data-guru-kepala')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{route('data-peserta-kepala')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-id-card"></i>
                <div data-i18n="Layouts">Data Peserta Didik</div>
              </a>
            </li>

            <!-- <li class="menu-item">
              <a href="{{route('tahun-mapel')}}" class="menu-link">
          ...
          >
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                  <a class="dropdown-item" href="{{route('logout-kepalaMadrasah')}}">
...
<script>
    $(document).ready(function() {
        ...
        function loadKegiatan() {
            $.ajax({
                url: "{{ route('load-kegiatan-kepala') }}",
                type: "GET",
                data: { page: page },

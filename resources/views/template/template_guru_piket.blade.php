      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item ">
              <a href="{{route('dashboard_guru_piket')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('data-jadwal-piket')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Jadwal</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('data-absen-peserta')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Absensi</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('catatan-ngaji-guru-piket')}}" class="menu-link ">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{route('logout-guru-piket')}}">
...
<script>
    $(document).ready(function() {
        ...
        function loadKegiatan() {
            $.ajax({
                url: "{{ route('load-kegiatan-guru-piket') }}",
                type: "GET",
                data: { page: page },

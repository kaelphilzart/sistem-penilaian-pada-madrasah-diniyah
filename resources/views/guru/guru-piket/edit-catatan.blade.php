<div class="modal fade" id="edit-catatan{{$dataCatatan->id}}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('update-catatan-ngaji', ['id' => $dataCatatan->id])}}" method="POST">
                    @csrf
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="isi lengkap" id="juz_surat" name="juz_surat"
                            style="height: 100px">{{$dataCatatan->juz_surat}}</textarea>
                        <label for="juz_surat">Juz Surat</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control"  id="hal" name="hal" value="{{$dataCatatan->hal}}">
                        <label for="hal">Halaman</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control"  id="ayat" name="ayat" value="{{$dataCatatan->ayat}}">
